...
import 'package:yyu_library/pages/author_detail_page.dart';
import 'package:yyu_library/pages/book_detail_page.dart';
               ...
               FutureBuilder(
                 ...
                 builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
                   if (snapshot.connectionState == ConnectionState.waiting) {
                     ...
                     return InkWell(
                      onTap: () async {
                    Get.to(AuthorDetail(), arguments: await snapshot.data[index]);
                  },
                       child: Stack(
                         children: [
                           ClipRRect(
                     ...
                     return Text('Veri bulunamadı'); // Null bir değer yerine bir hata mesajı göster
                   }
